...
class InputData:
    ...
    attributes:
        value: input path or virtual identifier (plugin sets)
        data: plugin-specific data (plugin sets)
              best practice: include 'source' field (e.g., data.source = 'scanner')
    """
    value: str
...
class OutputData:
    ...
    attributes:
        ...
        data: plugin-specific output data
              best practice: include 'source' field (e.g., data.source = 'tasker')
    """
